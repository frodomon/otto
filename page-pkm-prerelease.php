<?php //Template Name: PKM Pre-Release
get_header();  ?>
<div id="main" class="group">
    ...
    <div class="liga-content">
	  ...
	  <div class="liga-content" style="text-align:justify;">
			...
			<p class="text">Es un torneo donde los jugadores reciben cartas de la nueva expansión antes de la fecha de lanzamiento y compiten usándolas.</p>
			<p class="text"><strong>❗ TENGO UN HIJO PEQUEÑO AL QUE LE GUSTA POKÉMON Y QUIERE PARTICIPAR, ¿LE TOCARÁ JUGAR CON LA GENTE MAYOR?</strong></p>
			<p class="text">Play! Pokémon ofrece 3 categorías dependiendo de la edad que tenga el participante y son las siguientes:</p>
				<ul>
					<li><p class="text">» División Junior: Nacidos el año 2007 o después.</p>
					<li><p class="text">» División Senior: Nacidos entre los años 2003 y 2006.</p>
					<li><p class="text">» División Master: Nacidos el año 2002 o antes.</p>
				</ul>
			</p>
			<p class="text">Los participantes serán emparejados para participar únicamente con participantes de su categoría de edad siempre y cuando haya al menos 6 participantes, caso contrario se les tendrá que emparejar con los de su categoría más próxima.</p>
			<p class="text">Si eres un padre de familia o tutor de un menor que desea participar en los eventos de Play! Pokémon, recomendamos leer la información <a href="http://www.pokemon.com/es/play-pokemon/sobre/guia-para-padres-tutores/">aquí</a></p>
		</div>
