<?php //Template Name: PKM League Ago19
get_header();  ?>
<div id="main" class="group">
	<section id="intertiendas">
		...
		<div class="liga-images">
			<div class="liga-content">
				<h2>Fechas</h2>
				<img src="<?php print IMAGES.'/Otto Pokémon League Agosto 19 - Calendario.png' ?>" alt="Calendario" />
			</div>
			<div class="liga-content">
				<h2>Resultados</h2>
				<img src="<?php print IMAGES.'/Otto Pokémon League Agosto 19 - Resultados.png' ?>" alt="Resultados de la Liga" />
			</div>
			<div class="liga-content">
				<h2>Brackets Top 8</h2>
				<img src="<?php print IMAGES.'/Otto Pokémon League Agosto 19 - Brackets Top 8.png' ?>" alt="Brackets Top8" />
			</div>
		</div>
	</section>
</div>
